...
import { ApexAxisChartSeries, ApexChart } from 'ngx-apexcharts';
import { Top5Products, Top5ProductsPerHour } from '../../components/dash-boards/Interface-boards/dashBoards-Interfaces';
